...
class _LoginPageState extends State<LoginPage>
  ...
  Future<void> _login() async {
    ...
    // ── Normalize phone to match signup format ──────────────────────────────
    var rawDigits = _phoneCtrl.text.replaceAll(RegExp(r'\D'), '').trim();
    // Strip leading 0 if user typed 07... instead of 7...
    if (rawDigits.startsWith('0')) rawDigits = rawDigits.substring(1);
    final phone = '255$rawDigits';
    final pin = _pinCtrl.text.trim();

    if (rawDigits.isEmpty || pin.isEmpty) {
      setState(
  ...
  String _friendlyMessage(FirebaseException e, AppLocalizations l) {
    switch (e.code) {
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: _loading
                            ...
                            : Text(l.logIn, style: SButton.primaryLabel),
                      ),
                    ),
  ...
  Widget _buildHeading(AppLocalizations l, bool isDark) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(l.loginSubtitle, style: TextStyle(color: textSub, fontSize: 13)),
      ],
    );
  }
              ...
              Expanded(
                child: TextField(
                  ...
                  inputFormatters: [
                    ...
                    LengthLimitingTextInputFormatter(9), // 9 digits: 7XXXXXXXX
                  ],
