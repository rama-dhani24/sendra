...
class _ProfilePageState extends State<ProfilePage>
  ...
  void _showChangePinSheet(bool isDark) {
    showModalBottomSheet(
      ...
      builder: (_) =>
          _ChangePinSheet(userId: widget.userId, isDark: isDark),
    );
  }
        ...
        StreamBuilder<QuerySnapshot>(
          ...
          builder: (ctx, snap) {
            ...
            for (final doc in docs) {
              ...
              final isSender =
                  data[TxKeys.senderId] == widget.userId;
              final tzs =
                  (data[TxKeys.amountTzs] as num?)?.toDouble() ??
                      0;
              if (isSender) {
                totalSent += tzs;
                sentCount++;
              ...
              children: [
                Expanded(
                  child: _statCard(
                    label: l.totalSent,
                    value:
                        'TZS ${Validators.formatNumber(totalSent)}',
                    sub: l.isSwahili
                        ? '$sentCount miamala'
                ...
                Expanded(
                  child: _statCard(
                    ...
                    value:
                        'TZS ${Validators.formatNumber(totalReceived)}',
                    sub: l.isSwahili
          ...
          child: Column(
            children: [
              ...
              _actionRow(
                ...
                onTap: () {
                  Clipboard.setData(
                      ClipboardData(text: widget.accNumber));
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      ...
                      style:
                          const TextStyle(color: SColors.navy),
                    ),
                    backgroundColor: SColors.gold,
                    behavior: SnackBarBehavior.floating,
                    duration: const Duration(seconds: 1),
  ...
  Widget _actionRow({
    ...
    final c = color ?? (isDark ? SColors.textPrimary : SColors.lightTextPrimary);
    final textDim = isDark ? SColors.textDim : SColors.lightTextDim;
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(icon,
                color: color ?? SColors.gold, size: 20),
            const SizedBox(width: 12),
            Expanded(
              child: Text(
                label,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(l.tagline,
                  style: const TextStyle(
                      color: SColors.gold, fontSize: 13)),
              const SizedBox(height: 12),
              Text(
                l.isSwahili
        ...
        child: Column(
          ...
          children: [
            ...
            _pinField(
              ...
              hidden: _newHidden,
              onToggle: () =>
                  setState(() => _newHidden = !_newHidden),
              isDark: isDark,
            ),
            const SizedBox(height: 14),
            _pinField(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                        child: Text(_error, style: SText.errorText)),
                  ],
                ),
              ),
            ],
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: '••••',
              hintStyle:
                  TextStyle(color: textDim, fontSize: 15),
              suffixIcon: Padding(
                padding:
